...
namespace TerminusDotNetCore.Services
{
    public class ImageService : ICustomService
    {
        ...
        {
            var images = AttachmentHelper.DownloadAttachments(attachments);
            SixLabors.Fonts.Font robotoFont = SixLabors.Fonts.SystemFonts.CreateFont("Roboto", 50.0f);
            ...
            foreach (var image in images)
            {
                ...
                using (var baseImg = new Image<Rgba32>(userImg.Width, userImg.Height))
                {
                    ...
                    redditImg.Mutate(x => x.DrawText(subName, robotoFont, SixLabors.ImageSharp.Color.White, new SixLabors.ImageSharp.PointF(375, 65)));
